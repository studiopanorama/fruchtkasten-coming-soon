...
describe('SVGShapes', () => {
    describe('createEllipse', () => {
        test('should create a valid ellipse path', () => {
            ...
            expect(ellipse.encode()).toBe('M300 150A100 50 0 1 1 100 150A100 50 0 1 1 300 150z');
        });
        test('should create a circle when rx equals ry', () => {
            const circle = SVGShapes.createEllipse(50, 50, 100, 100);
            expect(circle.encode()).toBe('M150 100A50 50 0 1 1 50 100A50 50 0 1 1 150 100z');
        });
    });
    describe('createRect', () => {
        ...
        test('should create a rectangle with rounded corners', () => {
            ...
            expect(roundedRect.encode()).toBe('M25 20L195 20A15 10 0 0 1 210 30L210 110A15 10 0 0 1 195 120L25 120A15 10 0 0 1 10 110L10 30A15 10 0 0 1 25 20z');
        });
        test('should cap radius to half width/height if too large', () => {
            const rect = SVGShapes.createRect(10, 20, 100, 60, 60, 40);
            expect(rect.encode()).toBe('M60 20L60 20A50 30 0 0 1 110 50L110 50A50 30 0 0 1 60 80L60 80A50 30 0 0 1 10 50L10 50A50 30 0 0 1 60 20z');
        });
    });
...
//# sourceMappingURL=shapes.test.js.map